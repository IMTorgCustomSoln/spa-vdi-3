...
config = {
    ...
    'TRAINING_DATA_DIR': {
        ...
        'doc_product': Path('./models_data/doc_product/'),
        },
    'TASKS':[
        {
         ...
         },
        {
             ...
             'extension_patterns': ['.json'],
                 ...
                 {
            'class': CreateSingleUrlRecordTask,
            'name': 'created_pipeline_record',
            'extension_patterns': ['.json'],
         },
         {
             'class': ApplyClassifyDocModels,
             'name': 'classified_doc',
             'extension_patterns': ['.pickle'],
             'model_topics': ['doc_type','doc_product']
         },
        {
            'class': ApplyTextModelsTask,
            'name': 'classified_sentence',
            'extension_patterns': ['.pickle'],
            'model_topics': ['fees']
         },
         {
            'class': DisplayModelResultsOnPresentationDocTask,
            'name': 'displayed_model_results',
            'extension_patterns': ['.pickle'],
         },
    ]}
...
# option-2: url documents grouped by filename (if multiple exist)
option2_tasks = [
        {
...
#config['TASKS'].extend(option1_tasks)
