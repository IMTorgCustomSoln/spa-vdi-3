...
class AudioTranscription(ClassifierTemplate):
    ...
    def run(self, sound_files, intermediate_save_dir=None, infer_text_classify_only=False):
        ...
        self.config['LOGGER'].info(f'asr using device: {device}')
